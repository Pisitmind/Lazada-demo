          ...
          <div id="container_c" class="container_all" style="margin-top: 12px">
                ...
                <div class="list-header-container">
                  <div class="list-header">
                    ...
                    <div class="list-header-operate">
                      <div class="btn-wrap">
                        <v-btn @click="delBtn" class="btn-del" color="#f4f4f4">
                ...
                <div class="cart-item">
                  <div class="cart-item-inner">
                    <div class="cart-item-left">
                      ...
                      <div class="img-wrap">
                        <img class="img-set-size center" :src="cart.photo" />
                      </div>
                    ...
                    <div class="cart-item-right">
                      <div class="set-mid center">
                        <div class="input-quantity">
                          <v-btn elevation="2" small outlined color="blue">
                            <v-icon class="icn-a" @click="decrese(idx)">
                              mdi-minus
                            </v-icon>
                          </v-btn>
                          <input
                          ...
                          />
                          <v-btn elevation="2" small outlined color="blue">
                            <v-icon class="icn-a" @click="increcse(idx)">
                              mdi-plus
                            </v-icon>
                          </v-btn>
                        </div>
            ...
            <div id="right_container" class="container">
              <div class="list-header-top">
                    ...
                    <div class="location-checkout">
                      ...
                      <div class="location-body">
                        ...
                        <div class="location-address">
                          เชียงใหม่/ Chiang Mai,เมืองเชียงใหม่/ Mueang Chiang
                          Mai,50200
                        </div>
                      </div>
                    </div>
                ...
                <div class="summary-section">
                  <div class="summary-section-heading">Order Summarys</div>
                  <div class="summary-section-content">
                    <div class="checkout-sumaary">
                      <div class="checkout-sumaary-rows">
                        <div
                          class="checkout-sumaary-row"
                          style="
                            display: flex;
                      ...
                      <div class="voucher-input">
                        <div class="voucher-input-inner">
                          ...
                          <div class="voucher-input-btn">
                            <v-btn color="#1a9cb7"> Apply </v-btn>
                          </div>
                        </div>
                      </div>
                      <div class="checkout-order-total">
                        <div class="checkout-order-total-row">
                          ...
                          <div class="checkout-order-total-fee">
                            ฿ {{ subtotal }}
                            <small
                              class="checkout-order-total-fee-tip"
                              data-spm-anchor-id="a2o4m.cart.0.i8.2d226108KbUCT4"
                              >VAT included, where applicable</small
                            >
                          </div>
                        </div>
                        <v-btn
                          class="next-btn checkout-order-total-button"
                          color="#D0611e"
                        >
                          PROCEED TO CHECKOUT
                        </v-btn>
...
export default {
  ...
  watch: {
    checkbox_id() {
      ...
      if (this.checkbox_id.length === this.$store.state.carts.length) {
        this.abc = true
      } else this.abc = false
    },
  },
  ...
  methods: {
    checkAll() {
      if (this.checkbox_id.length < this.$store.state.carts.length) {
        this.checkbox_id = []
        this.$store.state.carts.forEach((element, index) => {
          this.checkbox_id.push(index)
        })
      } else if (this.checkbox_id.length === this.$store.state.carts.length) {
        this.checkbox_id = []
      }
    },
    increcse(index) {
    ...
    delBtn() {
      this.checkbox_id.forEach((element) => {
        this.$store.commit('remove', element)
      })
      this.checkbox_id = []
    },
  },
...
.list-header-top {
  background-color: (0, 250, 250, 0.5);
  margin-bottom: 12px;
}
